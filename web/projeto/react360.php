...
$quantidade_pg = (isset($_GET['pag']))? $_GET['pag'] :72;
//Selecionar todos os cursos da tabela
$sql1 = "select * from   imagenes ";  /// imagenes(imgruta,codigo) VALUES (:imgpath,:codigo)";
...
////////////////////////////////////////////////////////
 ...
 $sql = "select imgruta from   imagenes limit $incio, $quantidade_pg";
